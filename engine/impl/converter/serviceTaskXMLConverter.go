	...
	serviceTask := &model.ServiceTask{
		Task: model.Task{
			Activity: model.Activity{
				FlowNode: model.FlowNode{BaseHandlerType: delegate.BaseHandlerType(model.ServiceTask{}), IncomingFlow: make([]delegate.FlowElement, 0), OutgoingFlow: make([]delegate.FlowElement, 0)},
			},
		},
	}
